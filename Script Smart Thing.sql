...
( id INT AUTO_INCREMENT PRIMARY KEY,
 nivelInteresse INT, dataLeitura DATETIME, 
 dataExtracao DATETIME, fkEmpresa INT, 
 FOREIGN KEY (fkEmpresa) REFERENCES empresa(id) ON DELETE CASCADE );
...
('Cristhian Lauriano Rocha', '85963214596','cristhian.marqueze@sptech.school','senha_hashada','ATIVO',1),
('Fernando Henrique Santos Soares', '65932478512','fernando.soares@sptech.school','senha_hashada','ATIVO',9),
('Gustavo Aloe Gnecco', '20365478951', 'gustavo.moraes@sptech.school','senha_hashada','ATIVO',10),
('Denyel Henry Feitosa', '65932415627','denyel.oliveira@sptech.school','senha_hashada','ATIVO',3),
('Ana Cladia Ferreira','89654712304','ana.fsilva@sptech.school','senha_hashada','ATIVO',5);
